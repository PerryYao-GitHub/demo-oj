...
/*
AppResponse(outputs=[3, 7, 11], message=ok, status=0, memory=22634496, time=91)
*/
    }
    ...
    void wrongCodeTestOld() {
        ...
        System.out.println(response);
/*
AppResponse(outputs=null, message=/app/Main.java:3: error: incompatible types: String cannot be converted to int
        int a = args[0];
                    ^
/app/Main.java:4: error: incompatible types: String cannot be converted to int
        int b = args[1];
                    ^
2 errors
